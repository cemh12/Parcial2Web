...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/Offline">parcial2 web ONLINE</a>
        </div>
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCBIn1ruwthxNRkul-tGYM3dvq45sAz7p0&callback=initMap">
</script>
</body>
</html>
